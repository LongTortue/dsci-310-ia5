...
\pandocbounded{\includegraphics[keepaspectratio]{qmd_example_files/figure-pdf/fig-horse-pops-output-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{qmd_example_files/figure-pdf/fig-horse-pops-largest-sd-output-1.png}}

}

\caption{\label{fig-horse-pops-largest-sd}Horse populations for the
province with the largest standard deviation.}

\end{figure}%

In Figure~\ref{fig-horse-pops-largest-sd} we zoom in and look at the
